...
def _build_risks(changed_files: list[str]) -> list[str]:
    ...
    if any(file.lower() in {"readme.md", "contributing.md", "security.md"} for file in changed_files):
        risks.append("Project documentation changed: verify commands and examples are still accurate.")
